...
describe('AudioEngine', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should have frequency map', () => {
      expect(audioEngine.frequencies).toBeDefined();
      expect(typeof audioEngine.frequencies).toBe('object');
    });

    it('should have notes from C to B', () => {
      const notes = Object.keys(audioEngine.frequencies);
  ...
  describe('Note Frequencies', () => {
    it('should have correct frequency for A4 (440 Hz)', () => {
      const freq = audioEngine.getFrequency('A', 4);
      expect(freq).toBeCloseTo(440, 1);
    });

    it('should have correct frequency for C4 (261.63 Hz)', () => {
      const freq = audioEngine.getFrequency('C', 4);
      expect(freq).toBeCloseTo(261.63, 1);
    });

    it('should support octaves 0-6', () => {
      const c0 = audioEngine.getFrequency('C', 0);
      const c6 = audioEngine.getFrequency('C', 6);
    ...
    it('should handle sharp notes', () => {
      const cSharp = audioEngine.getFrequency('C#', 4);
      const c = audioEngine.getFrequency('C', 4);
      const d = audioEngine.getFrequency('D', 4);
  ...
  describe('Octave System', () => {
    it('should support octave range C2-C5', () => {
      const c2 = audioEngine.getFrequency('C', 2);
      const c5 = audioEngine.getFrequency('C', 5);
    ...
    it('should have correct octave ratios', () => {
      const c2 = audioEngine.getFrequency('C', 2);
      const c3 = audioEngine.getFrequency('C', 3);
      const c4 = audioEngine.getFrequency('C', 4);
