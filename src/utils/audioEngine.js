...
export const playNote = (note, octave, duration, timbre) => 
  audioEngine.playNote(note, octave, duration, timbre);

export const playChord = (notes, octave, duration, timbre) => 
  audioEngine.playChord(notes, octave, duration, timbre);

export const playProgression = (chords, octave, chordDuration, timbre) => 
  audioEngine.playProgression(chords, octave, chordDuration, timbre);

export const playScale = (notes, octave, noteDuration, timbre) => 
  audioEngine.playScale(notes, octave, noteDuration, timbre);

export const playInterval = (semitons, baseNote, octave, timbre) =>
  audioEngine.playInterval(semitons, baseNote, octave, timbre);
